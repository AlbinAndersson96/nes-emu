//! White-box unit tests. These reach into crate internals directly, so they
//! must compile inside the crate (an external `tests/` integration crate would
//! only see the public API). [`TestBus`] is the shared flat-memory fixture.
